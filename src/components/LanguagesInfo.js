    ...
    return (
      <List dense>
        <ListItem button component="a" href="https://github.com/blomki" divider>
          ...
          <ListItemText primary="blomki" secondary="https://github.com/blomki"/>
        </ListItem>
        <ListItem button component="a" href="https://twitter.com/fabr_fr" divider>
          <Avatar style={{
            backgroundColor: "#006e90"
          }}>
            <i className="devicon-twitter-plain"/>
          </Avatar>
          <ListItemText primary="@fabr_fr" secondary="https://twitter.com/fabr_fr"/>
        </ListItem>
        <ListItem
          button
          component="a"
          ...
          <ListItemText noWrap="true" primary="LinkedIn" secondary="Julien Foucher"/>
        </ListItem>
      </List>
    );
  }
